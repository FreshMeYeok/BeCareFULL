...
from CustomDataset_2 import CustomDataset
from OpticalLSTM_cellNum2 import OpticalLSTM
...
def main():
    ...
    dataset = CustomDataset(metadata_file, frames_folder, transform)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc >= best_acc:
            best_acc = val_acc
            filename = f'output/train_bi2/model_epoch{epoch + 1}.pt'
